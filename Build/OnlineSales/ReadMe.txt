...
FindProductsService, that is consumed by the ESB, should be on the following url
http://localhost/FindProductsService/
on the following url a help page about the methods provided va be found
http://localhost/FindProductsService/help


BasicFindProductsService, that is consumed by the ESB, should be on the following url
http://localhost/BasicFindProductsService/
